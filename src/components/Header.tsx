...
interface HeaderProps {
  ...
  pastPaperBoard?: 'edexcel' | 'aqa' | 'ocr-cs' | 'aqa-psychology' | 'edexcel-maths' | 'edexcel-maths-applied';
  revisionGuideBoard?: 'edexcel' | 'aqa' | 'ocr-cs' | 'aqa-psychology' | 'edexcel-maths' | 'edexcel-maths-applied';
