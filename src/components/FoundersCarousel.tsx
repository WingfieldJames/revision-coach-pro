      ...
      <div className="max-w-5xl mx-auto">
        <ScrollReveal className="text-center mb-12">
          <h2 className="text-[1.5rem] sm:text-[2.5rem] md:text-[3.25rem] lg:text-[4rem] font-bold mb-4 leading-[1.2]">
            ...
            <span className={isDark ? "text-gradient-brand" : "text-foreground"}>A* students</span>
          </h2>
        ...
        <div className="relative">
          ...
          <button onClick={goToNext} className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 bg-card border border-border rounded-full flex items-center justify-center shadow-card hover:shadow-elevated transition-shadow" aria-label="Next founder">
          ...
          <AnimatePresence mode="wait">
            ...
            duration: 0.3
          }} className={`backdrop-blur-xl rounded-3xl border border-border/50 p-8 md:p-12 overflow-hidden shadow-elevated ${isDark ? 'bg-gradient-to-br from-card/80 to-card/40' : 'bg-card'}`}>
