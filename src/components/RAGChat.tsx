            ...
            <div className="flex gap-2 mb-3 justify-center w-full">
              {suggestedPrompts.map((prompt, idx) => (
                <button 
                  ...
                  disabled={isLoading} 
                  className="px-3 py-2 rounded-full text-white text-xs sm:text-sm font-medium hover:opacity-90 transition-opacity disabled:opacity-50 bg-violet text-center min-w-0"
                >
                  {prompt.text}
                </button>
              ))}
