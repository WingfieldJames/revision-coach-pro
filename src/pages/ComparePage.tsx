    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="py-8 px-8 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-6 justify-center">
          {/* Free Plan */}
          <div className="bg-muted p-6 lg:p-8 xl:p-10 rounded-xl max-w-md lg:max-w-sm xl:max-w-md w-full shadow-card text-left">
            <h2 className="text-xl lg:text-2xl xl:text-3xl font-semibold mb-6">🎓 Free Plan</h2>
            <p className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-2">£0</p>
            <p className="text-sm lg:text-base xl:text-lg text-muted-foreground mb-6">Forever free</p>
            <ul className="space-y-4 lg:space-y-5 mb-8 text-sm lg:text-base xl:text-lg">
          ...
          <div className="hidden lg:block bg-muted p-6 lg:p-8 xl:p-10 rounded-xl max-w-md lg:max-w-sm xl:max-w-md w-full shadow-card text-left">
            <h2 className="text-xl lg:text-2xl xl:text-3xl font-semibold mb-2">🔥 Deluxe Monthly</h2>
            <p className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-2"><span className="line-through text-red-500 text-lg lg:text-xl xl:text-2xl">£9.99</span> £4.99<span className="text-base lg:text-lg xl:text-xl font-normal">/mo</span></p>
            <p className="text-sm lg:text-base xl:text-lg text-muted-foreground mb-6">Cancel anytime</p>
            <ul className="space-y-4 lg:space-y-5 mb-8 text-sm lg:text-base xl:text-lg">
              <li className="flex items-start">
                <span className="text-green-500 font-bold mr-2">✓</span>
          ...
          {/* Lifetime Plan */}
          <div className="bg-muted p-6 lg:p-8 xl:p-10 rounded-xl max-w-md lg:max-w-sm xl:max-w-md w-full shadow-card text-left border-2 border-primary relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground text-xs lg:text-sm xl:text-base font-semibold px-4 py-1.5 rounded-full">
              BEST VALUE
            </div>
            <h2 className="text-xl lg:text-2xl xl:text-3xl font-semibold mb-2">🔥 Deluxe Lifetime</h2>
            <p className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-2"><span className="line-through text-red-500 text-lg lg:text-xl xl:text-2xl">£39.99</span> £19.99</p>
            <p className="text-sm lg:text-base xl:text-lg text-muted-foreground mb-6">One-time payment • Save 67%</p>
            <ul className="space-y-4 lg:space-y-5 mb-8 text-sm lg:text-base xl:text-lg">
              <li className="flex items-start">
                <span className="text-green-500 font-bold mr-2">✓</span>
                AI trained on all {productType === 'edexcel' ? 'Edexcel Economics A' : 'AQA'} past papers (2017-2024, P1-P3)
