...
export const OCRPhysicsFreeVersionPage = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <ChatbotToolbar subjectName="OCR Physics" productId={OCR_PHYSICS_PRODUCT_ID} productSlug="ocr-physics" showMyAI showPastPaperFinder pastPaperBoard="ocr-physics" showExamCountdown examDates={OCR_PHYSICS_EXAMS} examSubjectName="OCR Physics" />
