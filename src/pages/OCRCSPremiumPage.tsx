...
export const OCRCSPremiumPage = () => {
  ...
  const sharedProps = {
    ...
    showMockExam: true,
    mockExamBoard: "OCR",
    mockExamSubject: "Computer Science",
    ...
    customPastPaperContent: <DynamicPastPaperFinder productId={OCR_CS_PRODUCT_ID} subjectName="OCR Computer Science" tier="deluxe" />,
  };
