              ...
              <div className="space-y-4 mt-2">
                ...
                <div className="bg-muted rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-sm">The Exam Season Pass (£19.99 one-time) might be better value — no recurring charges</p>
                  </div>
                </div>
                ...
                {cancelReason === 'Too expensive' ? (
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                    ...
                    <p className="text-sm text-green-700 dark:text-green-300">
                      Switch to the Exam Season Pass for £19.99 one-time — that's less than 3 months of your current subscription, and it covers you all the way through exams.
                    </p>
