      ...
      <section className="py-16 px-8 bg-muted">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 lg:gap-12 mb-6">
            <img src="/logos/openai-final.png" alt="OpenAI" className="h-8 md:h-10 lg:h-12 object-contain mix-blend-multiply dark:mix-blend-screen dark:invert" />
            <img src="/logos/gemini-final.png" alt="Gemini" className="h-8 md:h-10 lg:h-12 object-contain" />
            <img src="/logos/deepseek-final.png" alt="DeepSeek" className="h-6 md:h-8 lg:h-10 object-contain" />
          </div>
