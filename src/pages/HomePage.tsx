...
export const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      {/* Hero Section */}
      <section className="overflow-hidden pb-0 mt-0 md:mt-4 sm:-mt-4 md:max-lg:-mt-32 md:max-lg:pt-0">
        <HeroBackgroundPaths>
          <div className="px-6 sm:px-8 py-6 sm:py-24 md:py-32 md:max-lg:py-6 text-center max-w-5xl mx-auto">
