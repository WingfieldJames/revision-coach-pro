      ...
      <section className="overflow-hidden pb-0 -mt-8">
        ...
        <div className="text-center mb-8 -mt-20 relative z-50">
          <InteractiveHoverButton 
            ...
            className="pointer-events-auto text-base px-6 py-3 w-[200px] bg-white text-foreground border border-border group-hover:text-white transition-colors duration-300 [&>div:last-child]:bg-gradient-brand"
          />
